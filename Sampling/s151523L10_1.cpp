	...
	for (i = 0; i < MatSize; i++) {
		for (j = 0; j < MatSize; j++) {	
			for (k = 0; k < MatSize; k += 16) {
				...
				pDestMatrix[i * MatSize + k + 8] += pLeftMatrix[i * MatSize + j] * pRightMatrix[j * MatSize + k + 8];
				pDestMatrix[i * MatSize + k + 9] += pLeftMatrix[i * MatSize + j] * pRightMatrix[j * MatSize + k + 9];
				pDestMatrix[i * MatSize + k + 10] += pLeftMatrix[i * MatSize + j] * pRightMatrix[j * MatSize + k + 10];
				pDestMatrix[i * MatSize + k + 11] += pLeftMatrix[i * MatSize + j] * pRightMatrix[j * MatSize + k + 11];

				pDestMatrix[i * MatSize + k + 12] += pLeftMatrix[i * MatSize + j] * pRightMatrix[j * MatSize + k + 12];
				pDestMatrix[i * MatSize + k + 13] += pLeftMatrix[i * MatSize + j] * pRightMatrix[j * MatSize + k + 13];
				pDestMatrix[i * MatSize + k + 14] += pLeftMatrix[i * MatSize + j] * pRightMatrix[j * MatSize + k + 14];
				pDestMatrix[i * MatSize + k + 15] += pLeftMatrix[i * MatSize + j] * pRightMatrix[j * MatSize + k + 15];
			}
		}
	}
}
